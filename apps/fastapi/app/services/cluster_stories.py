...
REPO_FASTAPI = Path(__file__).resolve().parents[2]
DATA_DIR = Path(os.getenv("DATA_DIR", REPO_FASTAPI/ "data"))
SCRAPED_DIR = DATA_DIR / "scraped_articles"
OUT_DIR_DEFAULT = DATA_DIR / "cluster_output"
...
def main():
    ...
    ap.add_argument("--root", default=str(SCRAPED_DIR), help="Root folder of scraped_articles")
    ...
    ap.add_argument("--outdir", default=str(OUT_DIR_DEFAULT), help="Where to write outputs")
    args = ap.parse_args()
